...
**地铁网络覆盖模型**：由各线路站点的顺序构建图，**按线路特征分档均速**（城际/机场/快线/市域如杭海城际、19/16号线、绍兴1号线约 74 km/h + 更长停站；郊区稍快；市区密集站较慢约 36 km/h）+ 平均停站时间估计站间行驶时间，换乘另计约 2.5 分钟；用 Dijkstra 计算从某站到全网各站的站至站最小时间，得到时间预算内的「站至站可达」覆盖。
